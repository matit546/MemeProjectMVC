...
namespace MemesProject.Data.Migrations
{
    ...
    [Migration("20211212141538_RenameColumnUserAccountRegisterDate")]
    partial class RenameColumnUserAccountRegisterDate
    {
            ...
            modelBuilder.Entity("MemesProject.Models.Meme", b =>
                {
                    b.HasOne("MemesProject.Models.Category", "CategoryEntity")
                        .WithOne("Meme")
                        .HasForeignKey("MemesProject.Models.Meme", "IdCategory")
